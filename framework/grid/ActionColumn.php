 ...
 * ```
 *
 * 有关操作列的更多详细信息和用法信息, 参见《[指南》关于数据小部件的文章(指南:输出数据小部件)。
 *
...
class ActionColumn extends Column
{
     ...
     * 回调的签名应该一样[[createUrl()]]。
     * 自2 . 0 . 10以来，可以接受其他参数，这些参数指的是列实例本身:
     *
     * ```php
    ...
    /**
     * 初始化单个按钮的默认按钮呈现回调。
     * @param string $name 正如模板上所写的按钮名称
     * @param string $iconName The part of Bootstrap glyphicon class that makes it unique
     * @param array $additionalOptions 附加选项数组
     * @since 2.0.11
     */
     ...
     * 调用此方法对于每一个按钮,每一行。
     * @param string $action 按钮名称 (或动作ID)
     * @param \yii\db\ActiveRecordInterface $model 数据模型
     * @param  与数据模型相关联的关键
     * @param int $index 当前行指数
     * @ string 返回创建url
     */
